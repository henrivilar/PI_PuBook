          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-2">
              <div className="flex gap-3">
                ...
                <AccordionContent className="text-perguntas">
                Não. O uso do PuBook é completamente gratuito. Para acessar os livros disponíveis, basta realizar um cadastro simples na plataforma ou utilizar uma conta existente do Google, Facebook ou Microsoft. A partir disso, você poderá explorar e ler quantos livros desejar, sem qualquer custo.
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4">
              <div className="flex gap-3">
                ...
                <AccordionContent className="text-perguntas">
                Para começar a utilizar o PuBook, é necessário criar uma conta na plataforma por meio de um rápido processo de cadastro. Você também pode optar por entrar com uma conta do Google, Facebook ou Microsoft. Após o login, o acesso à biblioteca estará liberado e você poderá começar a explorar nosso acervo imediatamente.
                </AccordionContent>
            </AccordionItem>
